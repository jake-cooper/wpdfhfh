...
if (!function_exists("logo")) {
    function logo(){
        ...
        <a class="navbar-brand col-xs-9 col-sm-12 col-md-12" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"><i class="icon-cloud"></i> <?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?></a>
        <?php } else{ ?>            
        <a class="navbar-brand col-xs-9 col-sm-12 col-md-12" href="<?php echo esc_url( home_url( '/' ) ); ?>" >
            <img class="img-responsive" src="<?php echo zee_option( 'site_logo' );?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" />
        </a>
        <?php 
    }
}
